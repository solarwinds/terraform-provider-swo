...
- `monitoring` (Attributes) The Website monitoring settings. You are required to configure at least availability monitoring or real user monitoring to create a website. (see [below for nested schema](#nestedatt--monitoring))
